...
// Created By: Lorenzo
contract DuckyETCountryClub is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE_DUCKY_ET = 60000000000000000; // 0.06 ETH
    ...
    function mintSpookyBoys(uint256 numberOfSpookyBoys) external payable nonReentrant {
        ...
        require(numberOfSpookyBoys <= MAX_DUCKY_ET_PURCHASE, "Exceeds maximum Spooky Boys in one transaction.");
